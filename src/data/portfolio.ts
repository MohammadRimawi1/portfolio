...
export const projects: Project[] = [
  {
    ...
    tagline:
      "Spring Boot library platform with a React frontend, deployed live",
    year: "2026",
    role: "Sole developer",
    stack: ["Java", "Spring Boot", "MongoDB", "React", "TypeScript", "Docker"],
    summary:
      "A library management platform built with a Spring Boot backend and a React/TypeScript frontend, connected end to end and deployed live — backend on Render, frontend on Vercel.",
    details: [
      "Built the backend with Java and Spring Boot, using MongoDB for persistence.",
      "Built a React and TypeScript frontend that consumes the backend API.",
      "Containerized the backend with Docker and deployed it on Render.",
      "Deployed the frontend on Vercel, connected end to end to the live backend.",
    ],
    impact:
      "This is the project I'd point to for a full working system — a real backend, a real frontend, and both actually deployed and talking to each other, not just running locally.",
    github: "https://github.com/MohammadRimawi1/Library-Management-System",
    demo: "https://library-frontend-1-black.vercel.app/login",
    accent: "moss",
  },
  {
    ...
    tagline:
      "A team-built platform for lodging and tracking complaints end to end",
    year: "2026",
